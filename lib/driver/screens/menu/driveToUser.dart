...
import 'package:suppertaxi/driver/screens/menu/toUserGivenLocation.dart';
...
class DriveToUser extends StatefulWidget {
  const DriveToUser({super.key});

  @override
  State<DriveToUser> createState() => _DriveToUserState();
}

final List<MapObject> mapObjects = [];
const MapObjectId placemarkId = MapObjectId('normal_icon_placemark');
final GlobalKey<ScaffoldState> _driveToUserScaffoldKey =
...
void _showDriveToUserOrderDetails(BuildContext context) async {
  showModalBottomSheet(
    ...
    builder: (BuildContext context) {
      return const DriveToUserOrderDetails();
    },
  );
}

class _DriveToUserState extends State<DriveToUser> {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 15,
            child: InkWell(
              onTap: () => _driveToUserScaffoldKey.currentState?.openDrawer(),
          ...
          shouldChangeContent
              ? Positioned(
                  ...
                  child: Center(
                    child: HorizontalSlidableButton(
                      ...
                      height: 50.h,
                      buttonWidth: 50.0.w,
                      color: currentPosition == SlidableButtonPosition.end
                          ? const Color(0xff489D2C).withOpacity(0.50)
                          : const Color(0xff222222),
                      ...
                      onChanged: (position) {
                        if (position == SlidableButtonPosition.end) {
                          Navigator.of(context).push(MaterialPageRoute(
                            builder: (_) =>
                                const ToUserGivenLocation(), // Replace 'YourNewPage' with the page you want to navigate to
                          ));
                        }
                      },
                    ),
              ...
              : Positioned(
                  ...
                  child: InkWell(
                    onTap: () {
                      _showDriveToUserOrderDetails(context);
                    },
                    child: Container(
                      height: 50.h,
                      width: 300.h,
